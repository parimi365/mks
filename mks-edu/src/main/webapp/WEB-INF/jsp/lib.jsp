...
<link href="<c:url value="assets/img/favicon.png" />" rel="stylesheet"
	type="text/css">
...
<link rel="apple-touch-icon" sizes="76x76"
	href="<c:url value="img/apple-icon.png" />" type="text/css" />
<link rel="icon" type="image/png"
	href="<c:url value="assets/img/favicon.png" />" type="text/css" />
...
<!--   Core JS Files   -->
<script src="<c:url value = "js/jquery-3.1.0.min.js"/>"
	type="text/javascript"></script>
<script src="<c:url value = "js/bootstrap.min.js"/>"
	type="text/javascript"></script>
<script src="<c:url value = "js/material.min.js"/> "
	type="text/javascript"></script>
